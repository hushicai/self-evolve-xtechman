// pages/fortune-detail/fortune-detail.js
// 运势详情页 - 星座运势主题
...
function getFortuneText(score) {
  if (score >= 85) return '今日运势极佳，诸事顺遂'
  if (score >= 70) return '运势不错，适合开展新计划'
  if (score >= 55) return '运势平稳，保持平常心'
  if (score >= 40) return '运势略有波动，需谨慎行事'
  return '今日运势较低，宜静不宜动'
}
